...
{result.quantum_score!==undefined&&<div style={{marginBottom:"12px",padding:"14px",borderRadius:"10px",background:"rgba(139,92,246,0.08)",border:"1px solid #8b5cf6"}}><div style={{display:"flex",alignItems:"center",gap:"12px"}}><div style={{fontSize:"32px",fontWeight:"800",color:result.quantum_score>=90?"#4ade80":result.quantum_score>=60?"#f59e0b":"#f87171"}}>{result.quantum_score}%</div><div><div style={{color:"#8b5cf6",fontWeight:"700",fontSize:"14px"}}>Quantum-Readiness Score</div><div style={{color:subtext,fontSize:"12px"}}>{result.quantum_level}</div></div></div></div>}{result.pqc_suggested&&<span style={{display:"inline-block",marginBottom:"10px",padding:"4px 12px",borderRadius:"12px",fontSize:"12px",fontWeight:"700",background:"rgba(139,92,246,0.15)",color:"#8b5cf6",border:"1px solid #8b5cf6"}}>PQC Path Suggested</span>}

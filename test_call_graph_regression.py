...
# Test ast.parse directly (Python 2 print-statement WILL genuinely fail Python 3 ast.parse!)
import ast
try:
    ast.parse(bank_legacy_code)
    print("ast.parse: SUCCESS")
except SyntaxError as e:
    print("ast.parse: FAILED -", e)

# Test call graph function
result = main.analyze_call_graph(bank_legacy_code)
print("Call graph result:", result)